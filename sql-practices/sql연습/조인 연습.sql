...
-- 실습문제 2
-- 현재 회사에서 지급되고 있는 급여체계를 반영한 결과를 출력해보세요
-- 사번, 이름, 연봉 형태로 출력하세요
...
-- 예제 : 현재 직책별로 평균 연봉과 인원수를 구하되 직책별로 인원 100명 이상인 직책만 출력하세요.
...
-- 예제 : 현재 부서 별로 현재 직책이 Engineer인 직원들에 대해서만 평균급여를 구하세요
select d.dept_name, avg(b.salary)
    ...
    where a.emp_no = b.emp_no and b.emp_no = c.emp_no and a.dept_no = d.dept_no
	  and a.to_date = '9999-01-01' and b.to_date = '9999-01-01' and c.to_date = '9999-01-01' and c.title = 'Engineer'
 group by d.dept_name;   

-- 예제 : 현재 직책별로 금여를 총합을 구하되 Enginner 직책은 제외하세요 
-- 단 총합이 2,000,000,000 이상인 직책만 나타내며 급여총합에 대해서 내림차순으로 정렬하세요.
